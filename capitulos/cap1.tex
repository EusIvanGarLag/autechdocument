...
con el programa sintético de la asignatura, siguiendo la estructura de la Jerarquía de Chomsky,
desde autómatas finitos hasta Máquinas de Turing, exceptuando los lenguajes tipo~1 ya que no
están contemplados en el programa sintético de ISC 2020~\cite{ipn2020, hopcroft2007}.
...
computacionales de la Jerarquía de Chomsky, además de contar con un sistema de aprendizaje
...
\begin{itemize}
    ...
    \item Desarrollar un panel de analíticas en desktop orientado al perfil docente, capaz de
